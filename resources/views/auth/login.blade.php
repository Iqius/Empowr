...
<body class="flex justify-center items-center h-screen bg-gray-100 px-4">
    <div class="w-full max-w-sm p-8 bg-white shadow-md rounded-md text-center">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <input type="text" name="username" placeholder="Username" class="w-full mt-3 p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
            <input type="password" name="password" placeholder="Password" class="w-full mt-3 p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
