                ...
                <div class="flex justify-between items-center relative">
                    ...
                    @foreach ($stepsData as $index => $step)
                        ...
                        @if($index < count($stepsData) - 1)
                            <div class="flex-1 h-1 bg-gradient-to-r from-blue-200 via-gray-300 to-blue-200"></div>
                        @endif
                    @endforeach
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border flex flex-col h-full space-y-6 my-5">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <!-- Chat Button -->
                        <button
                            class="w-32 py-2 bg-[#1F4482] text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
                            Chat
                        </button>
                    </div>
                </div>
